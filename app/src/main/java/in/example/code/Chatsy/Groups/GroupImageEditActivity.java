...
public class GroupImageEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_group_image_edit);
        ...
        if (type.equals("single"))
        {
            ...
            group_name = getIntent().getStringExtra("gname");
        ...
        if(type.equals("single")){
            CropImage.activity(mImageuri)
                    .start(GroupImageEditActivity.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                Picasso.with(GroupImageEditActivity.this).load(resultUri).placeholder(R.drawable.default_send_image).into(imageView);
