...
//            String mChatUser = c.getTo();
//
//            Encryptor encryptor = new Encryptor();
//
//            String shared_key = encryptor.generateSharedKey(mCurrentUserId,mChatUser);
//
//            String c_getMessage = encryptor.decrypt(c.getMessage(),shared_key);
            ...
            if (from_user.equals(sender_user)) {
                ...
                File directory = new File(Environment.getExternalStorageDirectory()+File.separator+"Chatsy/"+"Message Documents");
                if (!directory.exists()){
                    if (directory.mkdirs())
                    {
