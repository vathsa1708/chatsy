...
public class Main2Fragment extends Fragment {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId() == R.id.action_request) {
                    Intent intent = new Intent(Objects.requireNonNull(getContext()), qrcodeMainActivity.class);
                    startActivity(intent);
        }
    ...
    private void upload_group(final String grp_name) {
        ...
        userMap.put("gstatus", "Hello Guys! Using Chatsy");
